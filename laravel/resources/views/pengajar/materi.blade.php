...
<div class="categories-wrapper light-blue darken-3" style="height: 48px">
  <div class="categories-container">
    <div class="container">
     ...
     <a href="#!" class="breadcrumb">Materi</a>
    </div>
        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <?php 
                $materi = App\Models\Materi::where(['id_guru'=>Auth::user('pengajar')->id ,'id_list_pelajaran'=> $pelajaran->id])->count();
              ?>
              <td>{{$materi}}</td>
              <td>
                <a href="{{url('pengajar/materi/list/'.$pelajaran->id)}}" class="btn blue">Detail</a>

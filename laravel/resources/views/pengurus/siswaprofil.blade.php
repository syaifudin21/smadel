...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb bg-white" style="padding: 0px">
    <li class="breadcrumb-item" aria-current="page"><a href="{{url('pengurus/siswabaru/')}}">Daftar Siswa Baru</a></li>
...
<div class="table-responsive-sm">
  <table id="example" class="table table-hover table-sm" style="width:100%">
      ...
      <tr><th>Lampiran Foto</th>
        <td>@if(!empty($siswa->foto))<a href="{{env('FTP_BASE').'/siswa/'.$siswa->foto}}">Lampiran Foto</a>@endif</td></tr>
      <tr><th>Lampiran Akte</th>
        <td>@if(!empty($siswa->akte))<a href="{{env('FTP_BASE').'/siswa/'.$siswa->akte}}">Lampiran Akte</a>@endif</td></tr>
      <tr><th>Lampiran KPS</th>
        <td>@if(!empty($siswa->kps))<a href="{{env('FTP_BASE').'/siswa/'.$siswa->kps}}">Lampiran Kps</a>@endif</td></tr>
      <tr><th>Lampiran Ijazah</th>
        <td>@if(!empty($siswa->ijazah))<a href="{{env('FTP_BASE').'/siswa/'.$siswa->ijazah}}">Lampiran Ijazah</a>@endif</td></tr>
  </table>

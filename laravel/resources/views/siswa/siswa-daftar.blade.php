        ...
        <div class="col s12 m4">
          <div class="card">
            <div class="card-image">
              <img src="{{env('FTP_BASE').'/prestasi/'.$prestasi->lampiran}}">
      ...
      <div class="row">
        ...
        <div class="row">
          <div class="col m2 s12 valign-wrapper">
            <img class="materialboxed" src="{{env('FTP_BASE').'/siswa/'.$siswa->foto}}" width="100%" id="foto">
          </div>
          ...
          <div class="col m2 s12 valign-wrapper">
            <img class="materialboxed" src="{{env('FTP_BASE').'/siswa/'.$siswa->ijazah}}" width="100%" id="ijazah">
          </div>
          <div class="col m4 s12">
            <div class="file-field input-field">
              <div class="btn btn-flat">

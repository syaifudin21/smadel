          ...
          {{ method_field('PUT') }}
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-9 col-md-4">
                      <p><img src="{{url(env('FTP_BASE').'/siswa/'.$siswa->foto)}}" id="foto" alt="" width="150" class="rounded"></p>
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-9 col-md-4">
                      <p><img src="{{url(env('FTP_BASE').'/siswa/'.$siswa->ijazah)}}" id="ijazah" alt="" width="150" class="rounded"></p>
                      <label class="custom-file">

...
<div class="container">
  <div id="dasbord" class="col s12">
    <form method="POST" action="{{route('artikel.siswa.update')}}" enctype="multipart/form-data">
        {{ csrf_field() }}
        {{ method_field('PUT') }}
        ...
        <div class="row">
            <div class="col m6 s12">
               <div class="input-field">
                  <input id="tag" type="text" class="validate" name="tag" value="{{$artikel->tag}}">
                ...
                <div class="input-field">
                  <textarea id="textarea1" class="materialize-textarea" name="text_pembuka">{{$artikel->text_pembuka}}</textarea>
            ...
            <div class="col m6 s12">
              <div class="file-field input-field">
                <div class="btn blue">
                  <span>Upload</span>
                  <input type="file" name="lampiran" src="{{url('')}}"  onchange="fotoURl(this)" >
                </div>
        ...
        <div class="input-field col s12">
          <textarea name="artikel" required>{{$artikel->artikel}}</textarea>
        ...
        <div class="row"><br>
        <button type="submit" class="col s12 btn blue">Update</button>
        </div>
  </div>
  </div>
</div>
